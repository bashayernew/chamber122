// public/js/header-auth-slot.js v8
  ...
  slot.innerHTML = `
    <div class="userbox" style="position:relative;display:inline-block">
      ...
      <div id="auth-menu"
        ...
        <a class="btn" style="width:100%;margin:4px 0" href="/dashboard.html#profile">Profile</a>
        <!-- if you have a dedicated page, swap to /profile.html -->
